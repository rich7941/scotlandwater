      ...
      {/* Main Content */
        ...
        <section className="py-16 bg-white">
          <div className="container max-w-4xl">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white border-l-4 border-purple-600 p-6 shadow-sm">
                <h3 className="font-bold text-[#5B2C6F] mb-2">Regular Testing</h3>
                <p className="text-lg text-gray-700">
        ...
        <section className="py-16 bg-white">
          <div className="container max-w-4xl">
            ...
            <div className="bg-red-50 border-l-4 border-red-600 p-6 my-6">
              <p className="text-[#5B2C6F] font-semibold mb-2">⚠️ Warning</p>
              <p className="text-lg text-gray-700">
        ...
        <section className="py-16 bg-gray-50">
          <div className="container max-w-4xl">
            ...
            <div className="space-y-4">
              <div className="bg-white border-l-4 border-purple-600 p-6 shadow-sm">
                <h3 className="font-bold text-[#5B2C6F] mb-2">Cost</h3>
                <p className="text-lg text-gray-700">
              ...
              <div className="bg-white border-l-4 border-purple-600 p-6 shadow-sm">
                <h3 className="font-bold text-[#5B2C6F] mb-2">Property Ownership</h3>
                <p className="text-lg text-gray-700">
              ...
              <div className="bg-white border-l-4 border-purple-600 p-6 shadow-sm">
                <h3 className="font-bold text-[#5B2C6F] mb-2">Landlord Hesitancy</h3>
                <p className="text-lg text-gray-700">
              ...
              <div className="bg-white border-l-4 border-purple-600 p-6 shadow-sm">
                <h3 className="font-bold text-[#5B2C6F] mb-2">Access Issues</h3>
                <p className="text-lg text-gray-700">
        ...
        <section className="py-16 bg-white">
          <div className="container max-w-4xl">
            ...
            <h3 className="text-2xl font-bold text-[#5B2C6F] mb-4">Legal Requirements</h3>
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-bold text-[#5B2C6F] mb-4">Technical Requirements</h3>
            ...
            <h3 className="text-2xl font-bold text-[#5B2C6F] mb-4">Special Cases</h3>
        ...
        <section className="py-16 bg-white">
          <div className="container max-w-4xl">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="bg-white border-l-4 border-purple-600 p-6 shadow-sm">
                <p className="text-lg text-gray-700">Contact ScotWater.</p>
              </div>
              <div className="bg-white border-l-4 border-purple-600 p-6 shadow-sm">
