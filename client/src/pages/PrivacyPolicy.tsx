          ...
          <div className="container max-w-4xl">
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 mb-8">
                ScotWater and its affiliated companies ("ScotWater") appreciate your interest in this website and other related or linked ScotWater websites. Your privacy is vital to ScotWater. We want you to understand our practices concerning gathering information from visitors to the website and concerning the uses we make of that information.
              </p>

              <h2 className="text-2xl font-bold text-[#1e3a8a] mb-4 mt-12">Information and Uses</h2>
              <p className="text-gray-700 mb-8">
                ScotWater does not actively collect personally identifying data from this website unless knowingly and expressly provided by you. While browsing our website, certain information may be passively recorded. We log your internet protocol ("IP") address to administrate or compile demographic information and monitor the usage and performance of this website. We use tracking technology ("Cookies") to collect such data as operating system, metrics, geographical location, and browser type to understand how visitors use this website. The recorded data is used anonymously.
              </p>

              <h2 className="text-2xl font-bold text-[#1e3a8a] mb-4 mt-12">Information Stored on Your Computer</h2>
              <p className="text-gray-700 mb-8">
              ...
              <h2 className="text-2xl font-bold text-[#1e3a8a] mb-4 mt-12">Conditions of Use, Notices, and Revisions</h2>
              <p className="text-gray-700 mb-8">
                If you choose to use our website, your visit and any dispute over privacy are subject to our General Terms of Use of our website and this Privacy Statement, including any limitations on damages, application of law provisions, and arbitration of disputes. ScotWater reserves the right to amend and or update this statement without notice at any time.
              </p>

              <h2 className="text-2xl font-bold text-[#1e3a8a] mb-4 mt-12">Contacting ScotWater about the content of this Privacy Statement</h2>
              <p className="text-gray-700 mb-4">
                If you have any questions about the contents of this Privacy Statement, please contact ScotWater's Data Privacy Office at the following address:
              </p>
              <div className="bg-gray-50 p-6 rounded-lg mb-8">
                <p className="text-gray-700 mb-0">
                  ...
                  Edinburgh, EH4 2HS<br />
                  <a href="mailto:support@scotwater.co.uk" className="text-purple-600 hover:underline">support@scotwater.co.uk</a>
                </p>
              </div>
              <p className="text-gray-700 mb-8">
              ...
              <h2 className="text-2xl font-bold text-[#1e3a8a] mb-4 mt-12">Web Beacons, Cookies, and Other Technologies</h2>
              <p className="text-gray-700 mb-8">
              ...
              <h3 className="text-xl font-bold text-[#1e3a8a] mb-4">Cookies and Local Storage Technologies</h3>
              ...
              <h3 className="text-xl font-bold text-[#1e3a8a] mb-4">Web Beacons</h3>
              <p className="text-gray-700 mb-8">
