    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-white">
        <div className="container max-w-4xl">
          ...
          <h3 className="text-2xl font-bold text-[#5B2C6F] mb-4">Lead Pipes</h3>
          ...
          <div className="bg-gray-50 p-8 rounded-lg mb-8">
            <h3 className="text-2xl font-bold text-[#5B2C6F] mb-4">Responsibilities: Who Owns Which Pipe?</h3>
          ...
          <h3 className="text-2xl font-bold text-[#5B2C6F] mb-4">Lead Pipe Replacement Service - What to Expect</h3>
          ...
          <div className="bg-[#5B2C6F]/10 p-8 rounded-lg mb-8">
            <h3 className="text-2xl font-bold text-[#5B2C6F] mb-4">Regulation and Water Safety Standards in Scotland</h3>
          ...
          <h3 className="text-2xl font-bold text-[#5B2C6F] mb-4">Testing and Taking Action</h3>
          ...
          <div className="bg-white border-2 border-[#5B2C6F] p-6 rounded-lg mb-8">
            <h3 className="text-2xl font-bold text-[#5B2C6F] mb-4">Landlord Legal Duties</h3>
            <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-2xl font-bold text-[#5B2C6F] mb-4">Why Replace Lead Pipes?</h3>
          <p className="text-lg text-gray-700 mb-4">
          ...
          {/* Mitigation Section */}
          <h3 className="text-2xl font-bold text-[#5B2C6F] mb-4">Mitigation While Awaiting Replacement</h3>
          <p className="text-gray-700 mb-4">
          ...
          <div className="bg-white border-2 border-[#5B2C6F] p-6 rounded-lg mb-8">
            <h3 className="text-2xl font-bold text-[#5B2C6F] mb-4">The Dangers of Partial Lead Pipe Replacement</h3>
            <p className="text-gray-700">
          ...
          {/* After Replacement */}
          <h3 className="text-2xl font-bold text-[#5B2C6F] mb-4">After Lead Pipe Replacement</h3>
          ...
          <h3 className="text-2xl font-bold text-[#5B2C6F] mb-4">Be Lead Aware and Take Action</h3>
          <p className="text-lg text-gray-700 mb-4">
          ...
          <h3 className="text-2xl font-bold text-[#5B2C6F] mb-4">The Benefits of Lead Pipe Replacement</h3>
          <p className="text-lg text-gray-700 mb-8">
          ...
          {/* How to Start */}
          <h3 className="text-2xl font-bold text-[#5B2C6F] mb-4">How to Start the Lead Pipe Replacement Process</h3>
          ...
          <div className="bg-[#1B3A6B] text-white p-8 rounded-lg text-center">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
              <a 
                ...
                className="bg-[#F4E04D] hover:bg-[#E5D13D] text-[#5B2C6F] font-bold px-8 py-4 rounded-lg text-xl flex items-center gap-3 transition-colors"
              >
                0800 206 2778
              ...
              <a 
                ...
                className="bg-white hover:bg-gray-100 text-[#5B2C6F] font-bold px-8 py-4 rounded-lg text-xl transition-colors"
              >
