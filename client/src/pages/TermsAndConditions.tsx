        ...
        <section className="py-16 bg-white">
          <div className="container max-w-4xl">
            <div className="prose prose-lg max-w-none">
              ...
              <h2 className="text-2xl font-bold text-[#1e3a8a] mb-4 mt-12">Terms and Conditions</h2>

              <h3 className="text-xl font-bold text-[#1e3a8a] mb-4 mt-8">1. Introduction</h3>
              ...
              <h3 className="text-xl font-bold text-[#1e3a8a] mb-4 mt-8">2. Company Details</h3>
              <div className="bg-gray-50 p-6 rounded-lg mb-6">
                <p className="text-gray-700 mb-0">
                  <strong>ScotWater</strong><br />
                  Registered Office: Hudson House, 8 Albany Street, Edinburgh, EH1 3QB<br />
                  Email: <a href="mailto:hello@scotwater.co.uk" className="text-purple-600 hover:underline">hello@scotwater.co.uk</a>
                </p>
              </div>
              ...
              <ul className="list-disc pl-6 mb-6 text-gray-700">
                <li>Debts up to £999.99: £40</li>
                <li>Debts between £1,000 and £9,999.99: £70</li>
                <li>Debts of £10,000 or more: £100</li>
              </ul>
              ...
              <h3 className="text-xl font-bold text-[#1e3a8a] mb-4 mt-8">8. Dispute Resolution</h3>
              <p className="text-gray-700 mb-6">
              ...
              <h3 className="text-xl font-bold text-[#1e3a8a] mb-4 mt-8">9. Privacy and Data Protection</h3>
              <p className="text-gray-700 mb-6">
              ...
              <h3 className="text-xl font-bold text-[#1e3a8a] mb-4 mt-8">10. Property and Risk</h3>
              <p className="text-gray-700 mb-4">
              ...
              <ol className="list-decimal pl-6 mb-6 text-gray-700">
                <li><strong>Demand Payment:</strong> Formally demand the outstanding payment from the customer, including any applicable interest and debt recovery costs.</li>
                <li><strong>Legal Action:</strong> Initiate legal proceedings to recover the outstanding amount, including the unpaid sum, interest, and legal costs.</li>
                <li><strong>Charging Order:</strong> Apply for a charging order against the property where the work was performed to secure payment of the outstanding amounts. A charging order places a legal charge on the debtor's property, ensuring the debt is secured against the property and must be paid out of the proceeds if the property is sold.</li>
              ...
              <ol className="list-decimal pl-6 mb-6 text-gray-700">
                <li><strong>Charging Order:</strong> ScotWater reserves the right to apply for a charging order against the property where the work was performed to secure payment of the outstanding amounts.</li>
              ...
              <ol className="list-decimal pl-6 mb-6 text-gray-700">
                <li>Ensure that any contractors employing ScotWater have made full payment for services rendered by ScotWater.</li>
                <li>Be aware of the potential for a charging order on their property if payment is not made by the contractor.</li>
                <li>Request proof of payment from the contractor to ScotWater before making final payments to the contractor.</li>
              </ol>

              <h3 className="text-xl font-bold text-[#1e3a8a] mb-4 mt-8">11. Special Conditions</h3>
              <p className="text-gray-700 mb-6">
              ...
              <h3 className="text-xl font-bold text-[#1e3a8a] mb-4 mt-8">12. Delays and Non-performance</h3>
              <p className="text-gray-700 mb-6">
              ...
              <h3 className="text-xl font-bold text-[#1e3a8a] mb-4 mt-8">14. Liability for Existing Pipework</h3>
              <p className="text-gray-700 mb-6">
              ...
              <h3 className="text-xl font-bold text-[#1e3a8a] mb-4 mt-8">15. Flooring and Surface Reinstatement</h3>
              <p className="text-gray-700 mb-6">
              ...
              <h3 className="text-xl font-bold text-[#1e3a8a] mb-4 mt-8">16. Legal Responsibilities</h3>
              <p className="text-gray-700 mb-6">
              ...
              <h3 className="text-xl font-bold text-[#1e3a8a] mb-4 mt-8">17. Entire Agreement</h3>
              <p className="text-gray-700 mb-6">
              ...
              <h3 className="text-xl font-bold text-[#1e3a8a] mb-4 mt-8">18. Post Works Investigations & Remedials</h3>
              <p className="text-gray-700 mb-6">
