      ...
      <main className="flex-1">
        ...
        <section className="relative h-[500px] flex items-center justify-center">
          <div 
            ...
            style={{ backgroundImage: 'url(/liverpool-lead-pipe-hero.webp)' }}
          >
          ...
          <div className="container relative z-10">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Lead Pipe Replacement<br />Liverpool
            </h1>
          </div>
        </section>
          ...
          <div className="container max-w-4xl">
            ...
            <div className="space-y-6 mb-8">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700">
                  As a trusted water services provider in Liverpool, all our lead pipe replacement complies with current UK Water Regulations. We ensure that your new pipe meets the latest health and safety standards, giving you peace of mind about your drinking water.
                </p>
              </div>
            </div>

            <h3 className="text-2xl font-bold text-[#1B3A6B] mb-4 mt-12">Regulation and Water Safety Standards in Liverpool</h3>
            <p className="text-lg text-gray-700 mb-4">
              In Liverpool, lead levels in drinking water are governed by the Water Supply (Water Quality) (England) Regulations 2010, which set the current legal limit at 10 micrograms per litre (10 µg/L).
            </p>
            <p className="text-lg text-gray-700 mb-4">
            ...
            <p className="text-lg text-gray-700 mb-4">
              From March 2024, all privately rented homes in Liverpool must be free of lead in the drinking water supply. This includes:
            </p>
            <ul className="list-disc pl-6 mb-4 text-lg text-gray-700">
              <li>Supply pipes</li>
