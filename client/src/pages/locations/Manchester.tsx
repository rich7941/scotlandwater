      ...
      <main className="flex-1">
        ...
        <section className="relative h-[500px] flex items-center justify-center">
          <div 
            ...
            style={{ backgroundImage: 'url(/manchester-lead-pipe-hero.webp)' }}
          >
          ...
          <div className="container relative z-10">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Lead Pipe Replacement<br />Manchester
            </h1>
          </div>
        </section>
          ...
          <div className="container max-w-4xl">
            ...
            <div className="space-y-6 mb-8">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700">
                  As a trusted water services provider in Manchester, all our lead pipe replacement complies with current UK Water Regulations. We ensure that your new pipe meets the latest health and safety standards, giving you peace of mind about your drinking water.
                </p>
              </div>
            </div>

            <h3 className="text-2xl font-bold text-[#1B3A6B] mb-4 mt-12">Regulation and Water Safety Standards in Manchester</h3>
            <p className="text-lg text-gray-700 mb-4">
              In Manchester, lead levels in drinking water are governed by the Water Supply (Water Quality) (England) Regulations 2010, which set the current legal limit at 10 micrograms per litre (10 µg/L).
            </p>
            <p className="text-lg text-gray-700 mb-4">
            ...
            <div className="bg-blue-50 border-l-4 border-[#1B3A6B] p-6 mb-8">
              ...
              <ul className="space-y-2 text-lg text-gray-700">
                ...
                <li><strong>Results:</strong> If lead exceeds 10 µg/l, or 5 µg/l from April 2025, United Utilities may replace its section. You must replace your private section first.</li>
            ...
            <p className="text-lg text-gray-700 mb-4">
              From March 2024, all privately rented homes in Manchester must be free of lead in the drinking water supply. This includes:
            </p>
            <ul className="list-disc pl-6 mb-4 text-lg text-gray-700">
              <li>Supply pipes</li>
            ...
            <ul className="list-disc pl-6 mb-6 text-lg text-gray-700">
              ...
              <li>Notify United Utilities for a follow-up inspection.</li>
            </ul>
            ...
            <div className="space-y-6 mb-8">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700">
                  Once English Water completes your private side lead pipe replacement, United Utilities will replace the lead communication pipe on the public highway free of charge.
                </p>
              </div>
            </div>
          </div>
