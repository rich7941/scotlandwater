      ...
      <main className="flex-1">
        ...
        <section className="relative h-[500px] flex items-center justify-center">
          <div 
            ...
            style={{ backgroundImage: 'url(/edinburgh-lead-pipe-hero.webp)' }}
          >
          ...
          <div className="container relative z-10">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Lead Pipe Replacement<br />Edinburgh
            </h1>
          </div>
        </section>
          ...
          <div className="container max-w-4xl">
            ...
            <div className="space-y-6 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  As a trusted water services provider in Edinburgh, all our lead pipe replacement complies with current UK Water Regulations. We ensure that your new pipe meets the latest health and safety standards, giving you peace of mind about your drinking water.
                </p>
              </div>
            </div>

            <h3 className="text-2xl font-bold text-[#1e3a8a] mb-4 mt-12">Regulation and Water Safety Standards in Edinburgh</h3>
            <p className="text-gray-700 mb-4">
              In Edinburgh, lead levels in drinking water are governed by the Water Supply (Water Quality) (Scotland) Regulations 2010, which set the current legal limit at 10 micrograms per litre (10 µg/L).
            </p>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-4">
              From March 2024, all privately rented homes in Edinburgh must be free of lead in the drinking water supply. This includes:
            </p>
            <ul className="list-disc pl-6 mb-4 text-gray-700">
              <li>Supply pipes</li>
        ...
        <section className="py-16 bg-gradient-to-r from-purple-900 to-blue-900">
          <div className="container text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Contact ScotWater for Lead Pipe Replacement in Edinburgh
            </h2>
            <p className="text-white text-lg mb-8 max-w-3xl mx-auto">
              If you're concerned about lead pipes in your Edinburgh property, contact ScotWater today. Our expert team is ready to assess your property and provide a comprehensive lead pipe replacement service tailored to your needs.
            </p>
