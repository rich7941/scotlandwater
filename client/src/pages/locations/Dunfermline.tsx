...
export default function Dunfermline() {
  return (
      ...
      <main className="flex-1">
        ...
        <section className="relative h-[500px] flex items-center justify-center">
          <div 
            ...
            style={{ backgroundImage: 'url(/dunfermline-lead-pipe-hero.webp)' }}
          >
          ...
          <div className="container relative z-10">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Lead Pipe Replacement<br />Dunfermline
            </h1>
          </div>
        </section>
        ...
        <section className="py-16 bg-white">
          <div className="container max-w-4xl">
            ...
            <h3 className="text-2xl font-bold text-[#1e3a8a] mb-4 mt-12">Regulation and Water Safety Standards in Dunfermline</h3>
            <p className="text-gray-700 mb-4">
              In Dunfermline, lead levels in drinking water are governed by the Water Supply (Water Quality) (Scotland) Regulations 2010, which set the current legal limit at 10 micrograms per litre (10 µg/L).
            </p>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-4">
              From March 2024, all privately rented homes in Dunfermline must be free of lead in the drinking water supply. This includes:
            </p>
            <ul className="list-disc pl-6 mb-4 text-gray-700">
              <li>Supply pipes</li>
