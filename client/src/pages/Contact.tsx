      ...
      <div className="py-12 bg-white">
        <div className="container">
          <div className="flex flex-wrap items-center justify-center gap-12 md:gap-24">
            <img src="/waterseal_logo.png" alt="WaterSeal" className="h-16 object-contain" />
            <img src="/wicc_logo.png" alt="WICC" className="h-16 object-contain" />
            <img src="/watertrust_logo.png" alt="WaterTrust" className="h-16 object-contain" />
          </div>
        </div>
      </div>
