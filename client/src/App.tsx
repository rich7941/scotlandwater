...
import Dunfermline from "./pages/locations/Dunfermline";
...
function Router() {
  ...
  return (
    <>
      ...
      <Route path="/locations/dunfermline" component={Dunfermline} />
      <Route path="/locations/hamilton" component={Hamilton} />
