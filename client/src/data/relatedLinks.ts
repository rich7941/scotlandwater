export const serviceRelatedLinks = [
  ...
  },
  {
    ...
    description: "Expert water supply pipe renewal services across Scotland with minimal disruption.",
  ...
  },
  {
    ...
    description: "24/7 emergency water main repair services across Scotland.",
...
export const helpAdviceRelatedLinks = [
  ...
  {
    title: "Impact Moling Prices 2025",
    description: "Comprehensive guide to impact moling costs and pricing in Scotland.",
