export default function WhyChoose() {
  const features = [
    ...
    {
      title: "Trusted Across Scotland",
      description: "Customers across Scotland have trusted us to handle their water mains services with reliability and professionalism."
    },
    {
